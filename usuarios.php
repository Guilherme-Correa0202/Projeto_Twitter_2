...
<head>
    <title>Usurios | Projeto para Web com PHP</title>
            ...
            <div class="col-md-10" style="padding-top: 50px;">
                    ...
                    <?php 
                        ...
                        $result = buscar(
                            ...
                            $criterio,
                            'dataCriacao DESC, nome ASC'
                        );
                    ?>
                    <table class="table table-bordered table-hover table-striped table-responsive{-sm|-ms|-lg|-xl}">
                        <thead>
                            <tr>
                                <td>Nome</td>
                                <td>E-mail</td>
                        ...
                        <tbody>
                            <?php
                                foreach($result as $entidade):
                                    $data = date_create($entidade['dataCriacao']);
