        ...
        <div class="col-md-12" style="padding-top: 50px;">
            ...
            <form method="post" action="core/post_repositorio.php" >
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" type = "Text" require="required" name="texto" id="texto" rows="5" <?php echo $entidade ['texto'] ?? '' ?>></textarea>
                </div>
                <div class="form-group">
                    <label for="texto">Postar em</label>
                    <?php
                        $data = (!empty($entidade['dataPostagem']))?
                            explode(' ', $entidade['dataPostagem'])[0]:'';
                        $data = (!empty($entidade['dataPostagem']))?
                            explode(' ', $entidade['dataPostagem'])[1]:'';
                    ?>
                    <div class="row">
                        <div class="col-md-3">
                            <input class="form-control" type="date" require = "required" name="dataPostagem" id="dataPostagem" value="<?php echo $data ?>">
                        </div>
                        <div class="col-md-3">
                             <input class="form-control" type="time" require = "required" name="horaPostagem" id="horaPostagem" value="<?php echo $hora ?>">
                        </div>
                    </div>
                </div>
