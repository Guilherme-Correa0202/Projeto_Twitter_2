            ...
            <div class="col-md-10" style="padding-top: 50px;">
                ...
                <form method="post" action="core/usuario_repositorio.php">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" required id="nome" name="nome" value="<?php echo $entidade['nome'] ?? ''; ?>">
                    </div>
                    
                    <div class="form-group">
                        <label for="email">E-mail</label>
                        <input class="form-control" type="text" required id="email" name="email" value="<?php echo $entidade['email'] ?? ''; ?>">
                    </div>
